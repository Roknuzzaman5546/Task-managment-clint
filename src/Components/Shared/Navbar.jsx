...
const Navbar = () => {
    ...
    return (
        <div className="bg-purple-900">
            <div className="navbar text-black font-bold w-11/12 mx-auto">
                <div className="navbar-start">
                    ...
                    <a className="btn btn-ghost text-2xl uppercase font-lobester font-bold">Build task</a>
                </div>
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-gray-800 text-white rounded-box w-52">
                            <li>
                                <a className="justify-between">
                                    Name
                                    <span className="badge p-4">{user.displayName}</span>
                                </a>
                            </li>
